...
function getUser() {
    $.ajax({
        url: "http://129.158.37.103:8082/api/user/all",
        type: "GET",
        datatype: "JSON",
...
function loadUser(idUser) {
    if (userType == 'ADM') {
        ...
        $.ajax({
            type: 'GET',
            datatype: "JSON",
            url: 'http://129.158.37.103:8082/api/user/' + idUser,
            success: function (response) {
                console.log(response);
                var item = response;
...
function saveUser() {
    if (userType == 'ADM') {
        ...
        $.ajax({
            ...
            datatype: "JSON",
            url: "http://129.158.37.103:8082/api/user/new",
    ...
    if (userType == 'ADM') {
        ...
        if (
            ...
            if (compare()) {
                ...
                $.ajax({
                    dataType: 'json',
                    url: "http://129.158.37.103:8082/api/user/update",
                    type: 'PUT',
                    data: dataSend,
                    contentType: "application/json; charset=utf-8",
